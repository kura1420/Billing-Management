    ...
    <table border="0" width="100%">
        <tr>
            <td width="50%" style="vertical-align: top;">
                ...
                <p>
                    <input name="area_product_promo_id" id="area_product_promo_id" class="easyui-combobox" data-options="label:'Product Promo',width:800,required:false,labelAlign:'right',disabled:true,labelWidth:120,valueField: 'id',textField: 'name',">
                </p>
                <p>
...
@include('pages.customer.data.detail')