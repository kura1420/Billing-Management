...
<div class="easyui-panel" data-options="fit:true,border:false,">
    <div id="tbs" class="easyui-tabs" style="width:100%;height:100%;"
        ...
        <div title="List">
            @include('pages.organization.departement.list')
        </div>

        <div title="Form">
            @include('pages.organization.departement.form')
        </div>
    </div>
    <div id="tab-tools">
...
<script src="{{ asset('assets/pages/organization/departement.js') }}"></script>
@endsection